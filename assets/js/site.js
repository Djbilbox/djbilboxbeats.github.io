...
const NAV = [
  ...
  { key:'mastering',   label:'Mastering',    href:'/ai-mastering.html',        icon:'fa-sliders' },
...
function mountSidebar(active){
  ...
  header.innerHTML = `
    <div class="topbar-in">
      <a href="/index.html" class="brand brand-logo"><img src="/img/djbilbox-logo.png" alt=""><span>HUM<span>PIRE</span></span></a>
